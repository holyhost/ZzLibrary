package com.zxyoyo.apk.zzlibrary.zview;
...
public class ZzPieChar extends View {
    ...
    private List<ZzPieCharEntry> pieEntries;
     ...
     * @param pieEntries
     */
    public void setPieEntries(List<ZzPieCharEntry> pieEntries) {
     ...
     * 每个扇形实体类相关信息
     */
    public static class ZzPieCharEntry {
        ...
        public ZzPieCharEntry(int number, int colorRes, boolean selected) {
            this.number = number;
